...
func main() {
	...
	for i := 0; i < iterations; i++ {
		url := fmt.Sprintf("https://%s.execute-api.us-east-1.amazonaws.com/Prod/x86?foo=bar", id)
		if i%2 == 0 {
			url = fmt.Sprintf("https://%s.execute-api.us-east-1.amazonaws.com/Prod/arm64?foo=bar", id)
		}
